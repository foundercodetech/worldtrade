...
import 'package:worldtrade/model/Mlm_Plan_model.dart';
...
import 'package:worldtrade/view/promotion/horizontal_scale.dart';
import 'package:worldtrade/view/promotion/horizontal_scale_two.dart';
import 'package:worldtrade/view/promotion/level_plan.dart';
                            ...
                            child: Column(
                              children: [
                                ...
                                AppBtn(
                                  ...
                                  fontWeight: FontWeight.w900,
                                  onTap: () async {
                                    String referralUrl = 'https://web.worldtrader.live?id=${userData.referralCode}';
                                    Share.share('Its my referral Code : *${userData.referralCode}* link to join: $referralUrl  ,'
                                        ' Download Now :https://worldtrader.live/worldtrader.apk',
                                        subject: 'Join Now !!');
                                ...
                                AppBtn(
                                  ...
                                  onTap: () async {
                                    await FlutterShare.share(
                                        ...
                                        linkUrl: "https://web.worldtrader.live?id=${userData.referralCode}",
