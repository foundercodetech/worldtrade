...
import 'package:worldtrade/res/components/image_picker.dart';
...
class _UploadScreenshotsState extends State<UploadScreenshots> {
  ...
  getImage()async{
    var res= await  http.get(Uri.parse("https://worldtrader.live/admin/index.php/Mahajongapi/usdt_slider"));
    print(res.body);
    var data = jsonDecode(res.body)["data"][0];
    print(data);
    setState(() {
      imagePath="https://admin.worldtrader.live/${data["image"]}";
    });
    print(imagePath);
  }
}
