...
import 'package:worldtrade/res/components/clipboard.dart';
import 'package:worldtrade/view/auth/customerService.dart';
...
import 'package:worldtrade/view/account/aboutus.dart';
import 'package:worldtrade/view/account/change_password.dart';
import 'package:worldtrade/view/account/logout.dart';
import 'package:worldtrade/view/account/service_center/contact_us.dart';
import 'package:worldtrade/view/account/service_center/privacy_policy.dart';
import 'package:worldtrade/view/account/service_center/terms_condition.dart';
import 'package:worldtrade/view/home/notification.dart';
                ...
                Stack(
                  ...
                  children: [
                    Container(
                      height: height * 0.39,
                      width: width,
                      decoration:   BoxDecoration(gradient:AppColors.goldenGradientDir,borderRadius: const BorderRadius.only(bottomLeft: Radius.circular(40),bottomRight:Radius.circular(40) )),
                      child: Padding(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          userData.referral_name==5?
                                          const AssetImage(Assets.medalBronze):
                                          userData.referral_name==10?
                                          const AssetImage(Assets.medalSilver):
                                          userData.referral_name==20?
                                          const AssetImage(Assets.medalStar):
                                          userData.referral_name==50?
                                          const AssetImage(Assets.medalGold):
                                          userData.referral_name==100?
                                          const AssetImage(Assets.medalPlatinum):
                                          userData.referral_name==250?
                                          ...
                                          const AssetImage(Assets.medalDiamond): const AssetImage(""),
                                              fit: BoxFit.fill
                                          )
                                      ),
                                      child: Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(width: 0.5, color: AppColors.goldencolor)),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
